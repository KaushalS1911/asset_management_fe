...
import EmployeeCreatePage from './asset-name-crete-view';
...
import AssetNameCreatepage from './asset-name-crete-view';
import AssetTypeCreatepage from './asset-type-create-view';
import AssetCompanyCreatepage from './asset-company-create-view';
...
export default function SettingsPage() {
  ...
  const [currentTab, setCurrentTab] = useState('Asset Name');
  ...
  return (
    <>
      <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        ...
        {currentTab === 'Asset Name' && <AssetNameCreatepage />}
        {currentTab === 'Asset Type' && <AssetTypeCreatepage />}
        {currentTab === 'Company' && <AssetCompanyCreatepage />}
