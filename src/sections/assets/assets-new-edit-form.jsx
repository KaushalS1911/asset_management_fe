...
useEffect(() => {
  ...
  const defaultValues = useMemo(
    () => ({
      ...
      warranty_start_date: currentProduct && currentProduct?.warranty_start_date && new Date(currentProduct?.warranty_start_date) || null,
      warranty_end_date: currentProduct && currentProduct?.warranty_end_date && new Date(currentProduct?.warranty_end_date) || null,
